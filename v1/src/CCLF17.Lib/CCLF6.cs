	...
	public class CCLF6Specs
	{
		...
		)
		{
			return new List<IFieldSpec>()
			{
				...
				new FieldSpecCategorical(CCLFData.CLM_TYPE_CD, CCLFData.LIST_CCLF6_CLM_TYPE_CD, false, null, 2, Util.Location.AtStart, Util.Location.AtEnd, null, null, null),
				...
				new FieldSpecCategorical(CCLFData.CLM_PRMRY_PYR_CD, CCLFData.LIST_PRMRY_PYR_CD, false, null, 1, Util.Location.AtStart, Util.Location.AtEnd, null, null, null),
				new FieldSpecDynamic(CCLFData.PAYTO_PRVDR_NPI_NUM, () => RNG.GetUniform(1000000000, 9999999999).ToString(), false, null, 10, Util.Location.AtStart, Util.Location.AtEnd, null, null, null),
				new FieldSpecDynamic(CCLFData.ORDRG_PRVDR_NPI_NUM, () => RNG.GetUniform(1000000000, 9999999999).ToString(), false, null, 10, Util.Location.AtStart, Util.Location.AtEnd, null, null, null),
