	...
	public class CCLF2Specs
	{
		...
		)
		{
			return new List<IFieldSpec>()
			{
				...
				new FieldSpecCategorical(CCLFData.CLM_LINE_PROD_REV_CTR_CD, CCLFData.LIST_CLM_LINE_PROD_REV_CTR_CD, false, null, 4, Util.Location.AtStart, Util.Location.AtEnd, null, null, null),
				new FieldSpecContinuousDateTime(CCLFData.CLM_LINE_INSTNL_REV_CTR_DT, DateTime.UtcNow.AddMonths(-4), DateTime.UtcNow.AddMonths(-1), false, "{0:yyyy-MM-dd}", 10, Util.Location.AtStart, Util.Location.AtEnd, null, null, null),
				...
				new FieldSpecContinuousNumeric(CCLFData.CLM_LINE_SRVC_UNIT_QTY, new DistUniform(-999999999999.9999, 999999999999.9999), 4, false, null, 24, Util.Location.AtStart, Util.Location.AtEnd, '0', null, null),
				new FieldSpecContinuousNumeric(CCLFData.CLM_LINE_CVRD_PD_AMT, new DistUniform(0, 99999999.99), 2, false, "{0:f2}", 17, Util.Location.AtStart, Util.Location.AtEnd, '0', null, null),
